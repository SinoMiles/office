...
export const toolCategories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'encrypt', name: 'PDF 密码保护', desc: '使用 AES-256 为 PDF 设置打开密码', icon: <Lock size={24} color="#3b82f6" />, comingSoon: false, accept: '.pdf', multiple: false, type: 'pdf-util', option: { name: 'password', label: '打开密码', placeholder: '至少输入 6 个字符', type: 'password' }, seo: seo('使用本机 qpdf 对 PDF 执行 AES-256 加密，设置打开文件所需的用户密码。文件和密码不会发送到第三方服务。', ['对外发送合同前设置打开密码', '保护财务报告和内部资料', '为邮件附件增加访问保护'], [['密码会被保存吗？', '不会。密码只存在于当前请求的受限临时文件中，处理结束后立即删除。'], ['忘记密码可以恢复吗？', '不能，请妥善保存密码；本站不会留存密码副本。']], ['pdf-clean-metadata', 'ai-redact']) },
    ]
  },
  {
    title: 'AI 智能文档处理 (Pro)',
